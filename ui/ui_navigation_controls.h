/********************************************************************************
** Form generated from reading UI file 'navigation_controls.ui'
**
...
#ifndef UI_NAVIGATION_CONTROLS_H
#define UI_NAVIGATION_CONTROLS_H
...
public:
    ...
    void setupUi(QWidget *navigation_controls)
    {
        if (navigation_controls->objectName().isEmpty())
            navigation_controls->setObjectName(QStringLiteral("navigation_controls"));
        navigation_controls->resize(474, 507);
        verticalLayout_4 = new QVBoxLayout(navigation_controls);
        verticalLayout_4->setObjectName(QStringLiteral("verticalLayout_4"));
        groupBox = new QGroupBox(navigation_controls);
        ...
        groupBox_2 = new QGroupBox(navigation_controls);
        ...
        groupBox_3 = new QGroupBox(navigation_controls);
        ...
        retranslateUi(navigation_controls);
        QObject::connect(m_alt_D_sb, SIGNAL(editingFinished()), navigation_controls, SLOT(on_edit()));
        QObject::connect(m_alt_I_sb, SIGNAL(editingFinished()), navigation_controls, SLOT(on_edit()));
        QObject::connect(m_alt_P_sb, SIGNAL(editingFinished()), navigation_controls, SLOT(on_edit()));
        QObject::connect(m_alt_ramp_sb, SIGNAL(editingFinished()), navigation_controls, SLOT(on_edit()));
        QObject::connect(m_bias_y_sb, SIGNAL(editingFinished()), navigation_controls, SLOT(on_edit()));
        QObject::connect(m_bias_x_sb, SIGNAL(editingFinished()), navigation_controls, SLOT(on_edit()));
        QObject::connect(m_bias_threshold_sb, SIGNAL(editingFinished()), navigation_controls, SLOT(on_edit()));
        QObject::connect(m_g_factor_sb, SIGNAL(editingFinished()), navigation_controls, SLOT(on_edit()));
        QObject::connect(m_threshold_dropout_cb, SIGNAL(toggled(bool)), navigation_controls, SLOT(on_edit()));
        QObject::connect(m_ant_reset_windup_cb, SIGNAL(toggled(bool)), navigation_controls, SLOT(on_edit()));
        QObject::connect(m_complex_der_cb, SIGNAL(toggled(bool)), navigation_controls, SLOT(on_edit()));

        QMetaObject::connectSlotsByName(navigation_controls);
    } // setupUi

    void retranslateUi(QWidget *navigation_controls)
    {
        navigation_controls->setWindowTitle(QApplication::translate("navigation_controls", "Form", 0));
        groupBox->setTitle(QApplication::translate("navigation_controls", "Navigation Parameters", 0));
        label_5->setText(QApplication::translate("navigation_controls", "PID Gain", 0));
        label_6->setText(QApplication::translate("navigation_controls", "Ramp Limit (%)", 0));
        label_7->setText(QApplication::translate("navigation_controls", "Bias Vector (X Y)", 0));
        label_12->setText(QApplication::translate("navigation_controls", "Bias Threshold Dist", 0));
        label_11->setText(QApplication::translate("navigation_controls", "G Factor", 0));
        label_13->setText(QApplication::translate("navigation_controls", "Threshold Dropout", 0));
        m_threshold_dropout_cb->setText(QString());
        label_8->setText(QApplication::translate("navigation_controls", "Anit-reset Windup", 0));
        m_ant_reset_windup_cb->setText(QString());
        label_9->setText(QApplication::translate("navigation_controls", "Complex Derivitive", 0));
        m_complex_der_cb->setText(QString());
        groupBox_2->setTitle(QApplication::translate("navigation_controls", "Lidar Commands", 0));
        m_command_cbox->clear();
        m_command_cbox->insertItems(0, QStringList()
         << QApplication::translate("navigation_controls", "Get Device Health", 0)
         << QApplication::translate("navigation_controls", "Get Device Information", 0)
         << QApplication::translate("navigation_controls", "Start Scan", 0)
         << QApplication::translate("navigation_controls", "Force Scan", 0)
         << QApplication::translate("navigation_controls", "Stop Scan", 0)
         << QApplication::translate("navigation_controls", "Reset", 0)
        );
        m_send_btn->setText(QApplication::translate("navigation_controls", "Send", 0));
        groupBox_3->setTitle(QApplication::translate("navigation_controls", "Pulsed Light Sensors", 0));
        label_3->setText(QApplication::translate("navigation_controls", "Ceiling Distance", 0));
        label_4->setText(QApplication::translate("navigation_controls", "Floor Distance", 0));
    } // retranslateUi

};

namespace Ui {
    class navigation_controls: public Ui_navigation_controls {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_NAVIGATION_CONTROLS_H
